...
test.describe('Game Lobby', () => {
  ...
  test('Show error message when room code is too long', async ({ Given, When, Then, And, page }) => { 
    await Given('I am on the start page', null, { page }); 
    await When('I enter the name "Filiph"', null, { page }); 
    await And('I click on "GÅ MED I SPEL"', null, { page }); 
    await When('I type "123ABCEW" into the roomcode field', null, { page }); 
    await And('I click on "ANSLUT NU"', null, { page }); 
    await Then('I should see the error "Rumskoden måste vara exakt 6 tecken."', null, { page }); 
  });
