...
- Name: e2e\features\smoke.feature.spec.js >> Smoke-test >> API:et svarar via proxyn
- Location: .features-gen\e2e\features\smoke.feature.spec.js:11:3

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:5173/api/hello
Call log:
  - navigating to "http://localhost:5173/api/hello", waiting until "load"
